    ...
    componentDidMount:function(){
        ...
        img.onload = (function(_this) {
            return function() {
                ...
                _this.refs.hitarea.getDOMNode().style.width = img.width+"px";
                _this.refs.hitarea.getDOMNode().style.height = img.height+"px";
                _this.initDrag();
            };
        })(this);
    ...
    render: function() {
        return (
            <div ref="hitarea" style={{width:"150px",height:"150px",background:"#fff"}}>
                <img ref="photoTarget" alt="image" className="photo-image" />
            </div>
        )
    }
});
