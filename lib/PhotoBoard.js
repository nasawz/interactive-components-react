...
var PhotoBoard = React.createClass({
  ...
  getInitialState:function(){
        ...
        content = (
          <div className="row" style={{paddingTop:"20px"}}>
            <div className="col-50">
              <a href="javascript:;" onClick={ this.onClickCancel } className="button button-big button-cancel btn-control">{this.props.buttonCancel}</a>
            </div>
            <div className="col-50">
              <a href="javascript:;" onClick={ this.onClickOk } className="button button-big button-ok btn-control">{this.props.buttonSure}</a>
            </div>
          </div>
        );
      }
    ...
    render: function() {
        return (
            <div style={this.props.style} className="PhotoBoard-warp">
